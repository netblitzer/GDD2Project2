...
public enum EnemyTypeD { triangle, square, circle };

public class enemy_Darren : MonoBehaviour {
	...
	void Start () {
        //switch (type) {
        //    default:
        //    case EnemyTypeD.triangle:
        //        gameObject.GetComponent<Material>().color = Color.red;
        //        break;
        //    case EnemyTypeD.square:
        //        gameObject.GetComponent<Material>().color = Color.green;
        //        break;
        //    case EnemyTypeD.circle:
        //        gameObject.GetComponent<Material>().color = Color.blue;
        //        break;
        //}
    }
